...
class UnitValue {
  ...
  isCompatibleWith(other) {
    ...
    return (this.isUnitless() && other.isUnitless()) || 
  ...
  add(other) {
    if (!this.isCompatibleWith(other)) {
      throw new Error(`Cannot add incompatible units: ${this.unit || 'unitless'} and ${other.unit || 'unitless'}`);
    }
  ...
  subtract(other) {
    if (!this.isCompatibleWith(other)) {
      throw new Error(`Cannot subtract incompatible units: ${this.unit || 'unitless'} and ${other.unit || 'unitless'}`);
    }
  ...
  multiply(other) {
    if (!this.canMultiplyWith(other)) {
      throw new Error(`Cannot multiply incompatible units: ${this.unit || 'unitless'} and ${other.unit || 'unitless'}`);
    }
  ...
  divide(other) {
    if (!this.canMultiplyWith(other)) {
      throw new Error(`Cannot divide incompatible units: ${this.unit || 'unitless'} and ${other.unit || 'unitless'}`);
    }
